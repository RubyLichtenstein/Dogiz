...
import dk.shape.dogbreeds.breeds.BreedsScreen
import dk.shape.dogbreeds.favorites.FavoriteCountBadge
import dk.shape.dogbreeds.favorites.FavoritesScreen
import dk.shape.dogbreeds.images.ImagesScreen
    ...
    NavHost(navController = navController, startDestination = Screen.BreedsList.route) {
        ...
        composable(
            ...
            if (breedArg != null) {
                ...
                ImagesScreen(navController = navController, breed = breed, subBreed = subBreed)
            }
        }
